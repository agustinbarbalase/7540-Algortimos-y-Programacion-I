...
void probar_esta_dentro_rango() {
  ...
  muestro_resultado(espero_bool(esta_dentro_rango(coordenada_personaje, 0, MAX_FILAS, 0, MAX_COLUMNAS), false));

  coordenada_personaje.fila = 1;
  coordenada_personaje.col = 1;
	
	muestro_resultado(espero_bool(esta_dentro_rango(coordenada_personaje, 0, MAX_FILAS, 0, MAX_COLUMNAS), true));
}
